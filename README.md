...
一个用于把活动录音、口述复盘、合作伙伴记录、同场公开报道调研和精选图片，整理成可发布公众号 Markdown 图文稿的 Codex skill。

它适合活动、圆桌、直播、工作坊、品牌会后报道、媒体/伙伴联动报道等场景。它不是让 AI 代写通稿，而是把现场材料、公开报道、图片和创作者判断组织成一篇有证据、有边界、能发布的文章草稿。
...
- 输出公众号 Markdown 草稿，包含标题候选、摘要、正文、图片占位、图注、素材使用说明和发布前确认。
